...
setGeneric("checkOrder", function(object) standardGeneric("checkOrder"))
...
setGeneric("cnEmission", function(object, stdev, k=5, cnStates=0:4, is.log=FALSE, verbose=TRUE, ...) standardGeneric("cnEmission"))
setGeneric("gtEmission", function(object, hmmOptions, cdfName, ...) standardGeneric("gtEmission"))
