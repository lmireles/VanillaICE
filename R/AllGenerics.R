...
setGeneric("cnEmission", function(object, stdev, k=5, cnStates=0:4,
				  is.log=FALSE, is.snp, verbose=TRUE, ...) standardGeneric("cnEmission"))
setGeneric("gtEmission", function(object, hmmOptions, gt.conf, is.snp, cdfName, ...) standardGeneric("gtEmission"))
